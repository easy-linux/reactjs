# React Router рефакторинг проекта с целью добавить поддержку DataAPI

## Введение

В данном примере продолжаем модифицировать существующий проект

- добавляем ленивую загрузку компонентов средствами React Router
